...
<template>
  <ListComponent title="Smartphones" button-text="See All Devices" class="smartphones-list">
    <template #actions>
      <ListDropdown :options="sortOptions" :selected="sortOptions[0]" />
    </template>
    <template #content>
      <SmartphoneListItem v-for="phone in smartPhones" v-bind:key="phone.id" :smartphone="phone" />
    </template>
  </ListComponent>
</template>
<style scoped>
